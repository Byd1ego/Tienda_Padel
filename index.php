    ...
    <div class="paginacion-container">
        ...
        <form method="get" style="display:flex; align-items:center; gap:8px;">
            ...
            <select name="por_pagina" id="por_pagina" onchange="this.form.submit()">
                <option value="6" <?php if ($productosPorPagina == 6)
                    echo 'selected'; ?>>6</option>
                <option value="12" <?php if ($productosPorPagina == 12)
                    echo 'selected'; ?>>12</option>
                <option value="24" <?php if ($productosPorPagina == 24)
        ...
        <div class="paginacion">
            <?php for ($i = 1; $i <= $totalPaginas; $i++): ?>
                ...
                <?php else: ?>
                    <a href="index.php?pagina=<?php echo $i; ?>&por_pagina=<?php echo $productosPorPagina; ?>"
                        class="pag-boton"><?php echo $i; ?></a>
                <?php endif; ?>
            <?php endfor; ?>
        </div>
